...
namespace ProgrammersBlog.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IResult> Delete(int categoryId, string modifiedByName)
        {
            ...
            return new Result(ResultStatus.Erros, "Böyle bir kategori bulunamadı.");
        }
        ...
        public async Task<IDataResult<CategoryDto>> Get(int categoryId)
        {
            ...
            return new DataResult<CategoryDto>(ResultStatus.Erros, "Böyle bir kategori bulunamadı.", null);
        }
        ...
        public async Task<IDataResult<CategoryListDto>> GetAll()
        {
            ...
            return new DataResult<CategoryListDto>(ResultStatus.Erros, "Hiç bir kategori bulunamadı.", null);
        }

        public async Task<IDataResult<CategoryListDto>> GetAllByNonDeleted()
        {
            /* !c.IsDeleted  ile c.IsDeleted == false anlamına geliyor */
