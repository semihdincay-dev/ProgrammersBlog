...
namespace ProgrammersBlog.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IResult> Delete(int articleId, string modifiedByName)
        {
            ...
            return new Result(ResultStatus.Erros, "Böyle bir makale bulunamadı.");
        }
        ...
        public async Task<IDataResult<ArticleDto>> Get(int articleId)
        {
            ...
            return new DataResult<ArticleDto>(ResultStatus.Erros, "Böyle bir makale bulunamadı.", null);
        }
        ...
        public async Task<IDataResult<ArticleListDto>> GetAll()
        {
            ...
            return new DataResult<ArticleListDto>(ResultStatus.Erros, "Böyle bir makale bulunamadı.", null);
        }
        ...
        public async Task<IDataResult<ArticleListDto>> GetAllByCategory(int categoryId)
        {
            ...
            if (result)
            {
                ...
                return new DataResult<ArticleListDto>(ResultStatus.Erros, "Makale bulunamadı.", null);
            }
            return new DataResult<ArticleListDto>(ResultStatus.Erros, "Böyle bir kategori bulunamadı.", null);
        }
